...
var Stock = /** @class */ (function () {
    function Stock(id, quantity, price, skeletonId, strategyId) {
        this.id = id;
    ...
    Stock.prototype.setId = function () {
    ...
    Stock.prototype.AddDataToDb = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        sql = "INSERT INTO Stock (Id, Price, Quantity, StockSkeletonId, InvestmentStrategyId) VALUES (?,?,?,?,?)";
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 6, , 7]);
                        return [4 /*yield*/, getDbConnection()];

...
var StockSkeleton = /** @class */ (function () {
    function StockSkeleton(id, side, skeletonId) {
        this.id = id;
        this.side = side;
    ...
    StockSkeleton.prototype.setId = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sql = "Select  count(*) as count from StockSkeleton";
    ...
    StockSkeleton.prototype.AddDataToDb = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        sql = "INSERT INTO StockSkeleton (Id, Side, InvestmentStrategySkeletonId) VALUES (?,?,?)";
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 6, , 7]);
                        return [4 /*yield*/, getDbConnection()];

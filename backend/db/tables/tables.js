...
const tableCreation = async () =>{
    ...
    const InvestmentStrategySkeletonTable = "create table if not exists InvestmentStrategySkeleton(Id int PRIMARY KEY, StrategyName varchar(30) NOT NULL UNIQUE, Description varchar(100), UserId int(50), FOREIGN KEY (UserId) REFERENCES User(Id))"; 
